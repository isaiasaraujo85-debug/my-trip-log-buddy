...
import { TransporteRecord, EmpresaConfig } from "@/types";
...
interface TransporteReportContentProps {
...
export function TransporteReportContent({ records, dataInicio, dataFim, total, empresaConfig }: TransporteReportContentProps) {
  ...
  return (
    <div>
      <div className="bg-white text-black" style={A4_LANDSCAPE}>
        ...
        <h2 className="text-lg font-bold mb-2">RELATÓRIO DE TRANSPORTE</h2>

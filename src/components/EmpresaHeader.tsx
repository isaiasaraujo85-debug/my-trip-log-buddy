...
export function EmpresaHeader() {
  ...
  return (
    <div className="space-y-3 mb-3 sm:mb-4 w-full">
      <div className="flex flex-row items-center justify-start gap-3 p-2 bg-muted/50 rounded-lg border w-full">
        <img
      ...
      <div className="flex justify-end p-2 bg-muted/50 rounded-lg border w-full">

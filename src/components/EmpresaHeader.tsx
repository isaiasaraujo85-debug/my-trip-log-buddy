...
export function EmpresaHeader() {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-start gap-2 p-2 mb-3 sm:mb-4 bg-muted/50 rounded-lg border w-full">
      {empresaConfig.logoBase64 ? (
        <img 
          src={empresaConfig.logoBase64} 
          alt="Logo" 
          className="w-16 h-16 sm:w-[300px] sm:h-[100px] object-contain flex-shrink-0"
        />
      ) : (
        <div className="w-16 h-16 sm:w-[300px] sm:h-[100px] bg-primary rounded flex items-center justify-center flex-shrink-0">
